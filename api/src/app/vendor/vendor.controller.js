...
async function get(req, res, next) {
  try {
    ...
    const result = await vendorService.getMultiple(filterSpec, page, pageSize);
    res.json(result);
  } catch (err) {
...
async function getById(req, res, next) {
  try {
    ...
    res.json(await vendorService.getById(id));
  } catch (err) {
...
async function create(req, res, next) {
  try {
    const tag = req.body;
    res.json(await vendorService.create(tag));
  } catch (err) {
...
async function update(req, res, next) {
  try {
    const id = req.params.id;
    const tag = req.body;
    res.json(await vendorService.update(id, tag));
  } catch (err) {
...
async function remove(req, res, next) {
  try {
    const id = req.params.id;
    res.json(await vendorService.remove(id));
  } catch (err) {
